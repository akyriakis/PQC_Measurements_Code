...
void Flute2_2_S_Extended_Characterization_with_xml(int nFiles)
{
   ...
   CVS_Output_File.open(Form("CSV_Info/VPX%d/Flute2_VPX%d_0xx_2-S_HM_E_W_Left_Extended_Info.csv",HM_Id,HM_Id));
